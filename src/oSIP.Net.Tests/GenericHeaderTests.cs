...
namespace oSIP.Net.Tests
{
    ...
    public class GenericHeaderTests
    {
        ...
        {
            using (var header = new GenericHeader("From", "sip:john.smith@abc.com"))
            {
        ...
        {
            using (GenericHeader original = new GenericHeader("From", "sip:john.smith@abc.com"))
            using (GenericHeader cloned = original.DeepClone())
            {
                original.Name = "To";
