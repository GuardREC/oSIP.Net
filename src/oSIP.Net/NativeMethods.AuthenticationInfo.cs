...
namespace oSIP.Net
{
    internal unsafe partial class NativeMethods
    {
        ...
        public static extern int osip_authentication_info_init(osip_authentication_info_t** header);

        [DllImport("osipparser2.dll")]
        public static extern int osip_authentication_info_parse(osip_authentication_info_t* header, IntPtr hvalue);

        [DllImport("osipparser2.dll")]
        public static extern int osip_authentication_info_to_str(osip_authentication_info_t* header, IntPtr* dest);

        [DllImport("osipparser2.dll")]
        public static extern void osip_authentication_info_free(osip_authentication_info_t* header);

        [DllImport("osipparser2.dll")]
        public static extern int osip_authentication_info_clone(osip_authentication_info_t* header, osip_authentication_info_t** dest);
    }
